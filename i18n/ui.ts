...
export const ui = {
  vi: {
    ...
    chat: {
      ...
      send: "Gửi",
      close: "Đóng chat",
      thinking: "Đang tìm trong hồ sơ…",
      error: "Xin lỗi, chatbot chưa trả lời được. Thử lại sau hoặc gửi email nhé.",
      offline: "Chatbot chưa bật. Cần chạy Ollama + chat-api (xem chat-api/README.md).",
    },
    detail: {
  ...
  en: {
    ...
    chat: {
      ...
      send: "Send",
      close: "Close chat",
      thinking: "Looking through his profile…",
      error: "Sorry, the chatbot could not answer. Please try again or send an email.",
      offline: "Chatbot is offline. Start Ollama + chat-api (see chat-api/README.md).",
    },
    detail: {
